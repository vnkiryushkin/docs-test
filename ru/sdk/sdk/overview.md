...
* [YDB SDK]{% if lang == "ru"%}(https://ydb.tech/docs/ru/reference/ydb-sdk/){% else %}(https://ydb.tech/docs/en/reference/ydb-sdk/){% endif %} — для [{{ ydb-full-name }}](../../ydb/) и [{{ yq-full-name }}](../../query/).
